...
pub(crate) static NODE2HW: &str = "./node2hw";
...
pub enum UsbCommand {
    ...
    StartAtGc { gc: u64 }, // = 0x27,    // start modulating and writing to the fifo at gc
    ReadAngles, // = 0x28,   // read postselected (measured) angles
    GetCurrentGc, // = 0x29, // get current global counter
    AngleSet { angles: [u8; 8] }, // = 0x2a,     // set the angles, expected 8 values (byte) to follow
